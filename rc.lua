...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioMute", function () awful.spawn.with_shell("pactil set-sink-mute @DEFAULT_SINK@ toggle") end),
    ...
    function ()
        if client.focus then
            local screen_idx = client.focus.screen.index
            local prev = screen_idx - 1
...
awful.key({ modkey, "Shift" }, ".",
    ...
    awful.key({ "Mod1", modkey }, "s", function () awful.spawn("orca") end,
            {description = "start screenreader", group = "screenreader"}),
    awful.key({ "Mod1", "Shift" }, "s", function () awful.spawn("pkill orca") end,
            {description = "kill screenreader", group = "screenreader"}),
    awful.key({}, "Print", function () awful.spawn.with_shell("flameshot gui -c") end,
    ...
    awful.key({ modkey, "Control" }, "q", function () awful.spawn.with_shell("$HOME/.config/rofi/powermenu.sh") end,
            {description = "start powermenu", group = "launcher"})
)
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey }, "t", function () awful.layout.set(awful.layout.suit.tile) end,
            {description = "tiling layout", group = "client"}),
